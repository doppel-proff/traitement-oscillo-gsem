...
Ibi_o = fu.open_csv("mesures\ess 10 bear cur out.csv")
...
#gu.graphsup(M,Path,Repo,Fig_name,Y_Axes,X_Axe)
gu.multigraph(M,Path,Repo_ind,Fig_name,Y_Axes,X_Axes)

M2=[[XIbi,YIbi],[XIbo,YIbo]]
gu.graphsup(M2,Path,Repo_sup,"Comparaison des courants en entré et sortie",["Test #10_Io mA","Test #10_Is mA"],"Temps en us")
